...
namespace Lucky4u.PhotonMultiplayer
{
	public class PUNConnectionManager : MonoBehaviourPunCallbacks, IOnEventCallback, IMultiplayerConnection, IPUNConnection
	{
		...
		private Action<Hashtable> OnRoomPropertiesUpdatedEvent;
		private Action<Player, Hashtable> OnPlayerPropertiesUpdatedEvent;
		#endregion
		...
		Action<Hashtable> IPUNConnection.OnRoomPropertiesUpdated { get => OnRoomPropertiesUpdatedEvent; set => OnRoomPropertiesUpdatedEvent = value; }
		Action<Player, Hashtable> IPUNConnection.OnPlayerPropertiesUpdated { get => OnPlayerPropertiesUpdatedEvent; set => OnPlayerPropertiesUpdatedEvent = value; }
		#endregion
		...
		{
			RaiseEvents(PUNConstants.PlayerReadyStatusCode,
						new object[]
						{
		...
		{
			Hashtable customPropertiesPacket = new Hashtable();
		...
		public void SetRoomCustomProperties(Hashtable customProperties)
		{
		...
		public Hashtable GetRoomCustomProperties()
		{
		...
		public void OnEvent(EventData photonEvent)
		{
			...
			switch (eventCode)
			{
				case PUNConstants.PlayerReadyStatusCode:
					...
					if (player != null)
					{
						Hashtable customProperty = player.CustomProperties;
						if (customProperty.ContainsKey("READY"))
						{
